...
Page({
    ...
    get_list: function() {
        var e = this;
        a.get("order/comment", e.data.options, function(t) {
            0 == t.error ? (t.show = !0, e.setData(t)) : (a.toast(t.message, "loading"), wx.navigateBack());
        }, !0);
    },
    select: function(a) {
    ...
    upload: function(t) {
        ...
        "image" == i ? a.upload(function(a) {
            n.push(a.filename), o.push(a.url), e.setData({
                images: n,
                imgs: o
            });
